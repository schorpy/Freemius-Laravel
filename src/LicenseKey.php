...
use Freemius\Laravel\Database\Factories\LicenseKeyFactory;
use Freemius\Laravel\Exceptions\MalformedDataError;

/**
 * The LicenseKey Key object
 * https://docs.Freemius.com/api/license-keys/the-license-key-object
 */
class LicenseKey extends Model
{
     ...
     * @var string
     */
    protected $table = 'freemius_license_keys';
