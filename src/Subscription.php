...
use Freemius\Laravel\Concerns\Prorates;
use Freemius\Laravel\Database\Factories\SubscriptionFactory;
use LogicException;
...
class Subscription extends Model
{
     ...
     * @var string
     */
    protected $table = 'freemius_subscriptions';
    ...
    {
        $response = Freemius::api('PATCH', "subscriptions/{$this->lemon_squeezy_id}", [
            'data' => [
                'type' => 'subscriptions',
    ...
    {
        $response = Freemius::api('DELETE', "subscriptions/{$this->lemon_squeezy_id}");
    ...
    {
        $response = Freemius::api('GET', "subscriptions/{$this->lemon_squeezy_id}");
